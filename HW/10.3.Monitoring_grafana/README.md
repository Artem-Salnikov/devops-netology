...
![Netdata](/HW/10.3.Monitoring_grafana/alert_discord.png)
...
![Netdata](/HW/10.3.Monitoring_grafana/data_sources.png)
...
- Количество места на файловой системе
    ```
    (﻿node_filesystem_free_bytes﻿{﻿device﻿=﻿"/dev/sda2"﻿}﻿)﻿ / ﻿1000000000
    деление было нужно для правильного отображения в Гб
    ```

Для решения данного ДЗ приведите promql запросы для выдачи этих метрик, а также скриншот получившейся Dashboard.

![Netdata](/HW/10.3.Monitoring_grafana/dashboard.png)
...
![Netdata](/HW/10.3.Monitoring_grafana/alerts.png)
...
```json
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "(node_filesystem_free_bytes{device=\"/dev/sda2\"}) / 1000000000",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
