...
Playbook установил и настроил необходимые пакеты. На картинке ниже видно, что Vector собирает демо-логи и отправляет в Clickhouse.

![Netdata](/HW/8.3.Yandex_cloud/lighthouse.png)
